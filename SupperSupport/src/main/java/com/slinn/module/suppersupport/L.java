...
public class L {
    private final static String TAG = "imslinn";
    ...
    public static void init(@Nullable String tag) {
        FormatStrategy formatStrategy = PrettyFormatStrategy.newBuilder()
                ...
                .tag(TextUtils.isEmpty(tag) ? TAG : tag)               //(Optional) Global tag for every log. Default PRETTY_LOGGER
                .build();
        Logger.addLogAdapter(new AndroidLogAdapter(formatStrategy));
    }

    public static void addLogAdapter(FormatStrategy formatStrategy) {
        Logger.addLogAdapter(new AndroidLogAdapter(formatStrategy));
    }
